...
/*
	패키지를 만드는 방법
		...
		-> 클래스가 다른 폴더(패키지)에 존재
			...
			-> 클래스가 public가 아니면 사용 x
			-> 메소드 / 생성자 -> public 가 아니면 사용 X
			-> 변수 -> 캡슐화 private
					  ------------ 기능 : 일기 / 쓰기
		...
		private : 자신의 클래스에서만 사용이 가능
				  인스턴스 변수
		default : 같은 패키지 내부에서만 사용이 가능
		protected : 같은 패키지 내부에서만 사용이 가능, 상속 시에 상속받은 클래스에서 사용이 가능
