...
implements ActionListener,MouseListener {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      else if(e.getSource() == join.b3)	// 회원가입
      {
    	  ...
    	  if(id.length() < 1)
    	  {
    		  JOptionPane.showMessageDialog(this, "ID를 입려하세요");
    	  ...
    	  if(pwd.length() < 1)
    	  {
    		  JOptionPane.showMessageDialog(this, "비밀번호를 입려하세요");
    	  ...
    	  if(name.length() < 1)
    	  {
    		  JOptionPane.showMessageDialog(this, "이름을 입려하세요");
    	  ...
    	  if(res == 0)
    	  {
    		  JOptionPane.showMessageDialog(this, "회원가입 실패하셨습니다.\n" + "다시 회원가입을 하세요.");
    	  }
    	  else
    	  {
