...
implements ActionListener,MouseListener,Runnable
{
    ...
    public ClientMainForm()
    {
    	...
    	setSize(800, 600);
    	setVisible(true);
    	setDefaultCloseOperation(DO_NOTHING_ON_CLOSE); // 창 닫기 버튼을 비활성화하고 수동 처리
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource()==join.b3) // 회원가입
		{
			...
			if(res==0)
			{
				JOptionPane.showMessageDialog(this, "회원 가입 실패하셨습니다\n"+"다시 회원가입을 하세요");
			}
			else
			{
				JOptionPane.showMessageDialog(this, "🎉🎉회원가입을 축합니다!!\n"+"로그인창으로 이동합니다");
		...
		else if(e.getSource() == wr.b5)
		{
			if(selectRow == -1)
			{
				JOptionPane.showMessageDialog(this, "정보 볼 아디디를 선택하세요");
				return;
			}
			   ...
			   while(true)
			   {
				   ...
				   switch(protocol)
				   {
				     ...
				     case Function.WAITCHAT:
				     {
				    	 ...
				    	 String chatColor = st.nextToken();
				    	 append(chatMessage, chatColor);
