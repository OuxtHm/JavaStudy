/*
	데이터 관리 --------데이터 가공(사용자 요청에 의해)--- 화면 출력
	-> 변수			   연산자 					  1. Application (콘솔 / 윈도우) -> 네트워크 
	-> 배열			   제어문						  2. WebApplication (브라우저)	  -> 데이터 베이스 
	-> 클래스										  3. MobileApplication		  -> XML, JSON
